This project allows the user to search the Spotify music catalog (you must have a Spotify account to use), and can create a custom playlist to save to your Spotify account.
